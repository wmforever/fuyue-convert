...
import cn.tensafe.ofd2word.task.*;
...
public class TaskController {
    ...
    public ResponseEntity<TaskSnapshot> create(@RequestPart("files") List<MultipartFile> files) throws IOException {
        ...
        return ResponseEntity.status(HttpStatus.ACCEPTED).body(tasks.createTask(uploads));
    }
